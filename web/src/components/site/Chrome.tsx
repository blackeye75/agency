...
// Between inner pages: a solid block of three tilted marquee bands sweeps up
// over the page, the route changes underneath, and the block lifts off.
...
// Going to the home page: the intro loader (0–100% counter, three colour
// columns) slides up, counts while the page loads, then lifts off.
export function Curtain({ text }: { text: string }) {
  const { curtainRef } = useSite()
  useGSAP(() => {
